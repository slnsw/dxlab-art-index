  ...
  render() {
    ...
    return (
      <WebsiteApp
        ...
        metaImageUrl={`${config.baseUrl}/images/masthead-newselfwales.gif`}
      >
        <Masthead
          ...
          backgroundImageUrl="/images/masthead-newselfwales.jpg"
          // backgroundImageUrl="/images/masthead-aereo.jpg"
          // backgroundImageUrl="/images/masthead-scout.jpg"
          // backgroundImageUrl="/images/masthead-80hz-street.jpg"
          // backgroundImageUrl="/images/masthead-aereo-v2.jpg"
          slug="Experimental"
          size="lg"
          caption="#NewSelfWales"
        />
        ...
        <Masthead
          ...
          backgroundImageUrl="/images/masthead-meridian-celestial.jpg"
          slug="We Make"
        />
              ...
              <MainTile
                ...
                imageUrl={
                  getExperimentTileSize(i) === '1x2'
                    ? experiment.fullImageUrl
                    : experiment.largeImageUrl
                }
...
function mapItemToTile(item) {
  return {
    ...
    largeImageUrl:
      item.featuredMedia && item.featuredMedia.sizes.largeTile.sourceUrl,
    fullImageUrl: item.featuredMedia && item.featuredMedia.sizes.full.sourceUrl,
